...
// excel data import
var data = [
    ['Wissenskultur', 'Wissenskultur.svg', 'w', 'elevator', 'augmented learning', 'bildungs-business', 'co-working', 'crowd-sourcing', 'digital creatives', 'digital literacy', 'edutainment', 'health literacy', 'kollaboration', 'learning analytics', 'lifelong learning', 'open innovation', 'open knowledge', 'playfulness', 'talentismus', '24/7 Gesellschaft', ],
    ['Konnektivität', 'Konnektivität.svg', 'k', 'jeopardy', '3D-Printing', 'Augmented reality', 'autonomes Fahren', 'Big data', 'Blockchain', 'business ecosystems', 'carsharing', 'crowdsourcing', 'crypto-currencies', 'cybercrime', 'digital creatives', 'digital health', 'digital literacy', 'digital reputation', 'internet of things', 'kollaboration', 'künstliche Intelligenz', 'learning analytics', 'omline', 'omni-channeling', 'predictive analytics', 'privacy', 'real-digital', 'seamsless mobility', 'selftracking', 'smart city', 'smart devices', 'social networks', ],
    ...
    ['Neo-Ökologie', 'Neo-Oekologie.svg', 'ö', 'dickunddoof', 'Achtsamkeit', 'Bio-Boom', 'Circular Economy', 'Direct Trade', 'E-Mobility', 'Flexitarier', 'Green Tech', 'Gutbürger', 'Lebensqualität', 'Minimalismus', 'Post-Carbon-Gesellschaft', 'Postwachstumsökonomie', 'Sharing-economy', 'Sinn-Ökonomie', 'slow culture', 'social business', 'urban farming', 'zero waste', ],
    ...
    ['Individualisierung', 'Individualisierung.svg', 'i', 'pat', 'achtsamkeit', 'alltags outsourcing', 'diversity', 'do it yourself', 'hygge', 'identitätsmanagement', 'Lebensqualität', 'LGBTQ', 'mass customization', 'Multigrafie', 'Neo-Tribes', 'Postdemografie', 'Resonanzgesellschaft', 'self balancer', 'sex-design', 'Single-Gesellschaft', 'Wir-Kultur', ],
    ...
    ['New Work', 'New Work.svg', 'n', 'java', 'Blockchain', 'business ecosystems', 'co-working', 'coopetition', 'corporate health', 'digital literacy', 'diversity', 'gig economy', 'internet of things', 'kollaboration', 'kreativ-ökonomie', 'open innovation', 'permanent beta', 'plattform ökonomie', 'service ökonomie', 'social business', 'start-up culture', 'talentismus', 'urban manufacturing', 'womanomics', 'work-life-blending', ],
    ['Gender Shift', 'Gender Shift.svg', 't', 'elephant', 'Diversity', 'LGBTQ', 'new feminism', 'post-gender-Marketing', 'progressive parents', 'proll professionals', 'sex-design', 'ungendered lifestyle', 'womanomics', 'work-life-Blending', ],
    ['Silver Society', 'Silver Society.svg', 'y', 'dickunddoof', 'digital Health', 'downaging', 'forever youngster', 'free ager', 'Golden Mentor', 'Lifelong Learning', 'Post-Demographie', 'Slow culture', 'Talentismus', 'Unruhestand', 'Universal Design', ],
    ['Mobilität', 'Mobilitaet.svg', 'm', 'spanish-flea', 'autonomes Fahren', 'Bike-Boom', 'carsharing', 'Dash delivery', 'De-Touristification', 'E-mobility', 'Globale Migration', 'mikro-mobilität', 'moderne Nomaden', 'Omni-channeling', 'Seamsless mobility', 'third places', 'Unterwegs-märkte', ],
    ['Sicherheit', 'Sicherheit.svg', 's', 'jeopardy', 'autonomes Fahren', 'big data', 'Blockchain', 'business Ecosystems', 'cybercrime', 'digital health', 'digital literacy', 'digital reputation', 'flexicurity', 'hygge', 'identitäts-management', 'internet of things', 'predictive analytics', 'privacy', 'selftracking', 'simplexity', 'smart city', 'super-safe-society', 'transparenzmärkte', 'trust technology', ],
]
