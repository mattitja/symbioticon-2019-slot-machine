...
var data = [
    ...
    ['Gesundheit', 'Gesundheit.svg', 'g', 'spanish-flea', 'Achtsamkeit', 'big data', 'bike-boom', 'corporate health', 'detoxing', 'digital health', 'flexitatier', 'healing architecture', 'health literacy', 'healthy hedonims', 'holistic health', 'komplementärmedizin', 'Lebensqualität', 'Mind-sport', 'movement culture', 'preventive health', 'sportivity', 'self balancer', 'self tracking', ],
